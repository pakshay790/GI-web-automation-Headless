...
public class commonPage {
	...
	public static WebElement sidebarAR(WebDriver driver)
	{
		WebElement element=null;
		WebDriverWait wait=new WebDriverWait(driver, 100);
		element=wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//body/app-root[1]/app-page-note[1]/div[1]/main[1]/div[1]/aside[1]/app-partial-leftnav_new[1]/section[1]/ul[1]/li[2]/div[1]/a[1]/i[1]")));
		return element;
	}
